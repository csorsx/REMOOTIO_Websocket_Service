...
exports.remootioApiConstructEncrypedFrame = exports.remootioApiDecryptEncrypedFrame = void 0;
...
function remootioApiDecryptEncrypedFrame(frame, ApiSecretKey, ApiAuthKey, ApiSessionKey) {
    ...
    var decryptedPayloadWordArray = CryptoJS.AES.decrypt(CryptoJS.lib.CipherParams.create({ ciphertext: payloadWordArray }), CurrentlyUsedSecretKeyWordArray, {
        iv: ivWordArray,
...
exports.remootioApiDecryptEncrypedFrame = remootioApiDecryptEncrypedFrame;
/**
 ...
 */
function remootioApiConstructEncrypedFrame(unencryptedPayload, _ApiSecretKey, ApiAuthKey, ApiSessionKey) {
    //STEP 0 - Get the relevant keys used for encryption
    ...
    var encryptedPayloadWordArray = encryptedData.ciphertext; //In CryptoJS encryptedData.ciphertext contains the ciphertext as a word array
...
exports.remootioApiConstructEncrypedFrame = remootioApiConstructEncrypedFrame;
